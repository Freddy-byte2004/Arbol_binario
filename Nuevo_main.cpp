...
// funcion para insertar nodos al arbol
    void insertar_nodo(Nodo *&sub_arbol,int Numero){
        ...
        sub_arbol=nuevo;// sub_arbol se iguala a ese nuevo nodo y toma todos sus atributos
        }
...
void mostrar_arbol(Nodo *arbol,int contador){
    if(arbol==NULL){
        ...
        mostrar_arbol(arbol->getderecha(),contador+1);
        for (int i=0; i<contador; i++){
        cout<<"  ";
        }
    cout<<arbol->getNumero()<<endl;
        mostrar_arbol(arbol->getizquierda(), contador+1);
    }
    }
...
int regresar_menu, busqueda_nivel,Raiz_nodo;
    cout<< endl;
cout<< "Ingrese una opcion "<<endl;
cout<< "1)Ingresar un Nodo"<<endl;
cout<< "2)PosOrden"<<endl;
cout<< "3)PreOrden"<<endl;
cout<< "4)Inorden"<<endl;
cout<< "5)Mostrar niveles del arbol"<<endl;
cout<< "6)Mostrar Arbol horizontal"<<endl;
cout<< "7)Salir"<<endl;
cin>> opciones;
switch(opciones){

case 1:
    while(regresar_menu!=2){
        system("cls");
    cout<< "Ingrese un elemento "<<endl;
    cin>> Raiz_nodo;
    Arbol_completo.insertar_nodo(_Arbol,Raiz_nodo);
    cout<<endl;
    cout<<"1)Ingresar otro nodo"<<endl;
...
case 5:
    ...
    case 6:
    system("cls");
    Arbol_completo.mostrar_arbol(_Arbol,contador);
   cout<<endl;
    cout<<endl;
    cout<< "1) Regresar al menu "<<endl;
    cout<< "2) Salir"<<endl;
